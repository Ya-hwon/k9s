...
### o Decode Secrets On Demand
  ...
  In the secret view you can use `ctrl-x` to decode a selected secret. [Feature #123](https://github.com/Ya-hwon/k9s/issues/123)

### o YAML Highlighter

  Describe and YAML commands will now yield syntax highlighted view.
  [Feature #142](https://github.com/Ya-hwon/k9s/issues/142)

---

## Resolved Bugs

+ Sort by age busted [Issue #145](https://github.com/Ya-hwon/k9s/issues/145)
+ Logs not escaped correctly [Issue #137](https://github.com/Ya-hwon/k9s/issues/137)
